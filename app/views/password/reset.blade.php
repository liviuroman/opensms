...
@section('content')
	...
	<div>
		...
		<form action="{{ action('RemindersController@postReset') }}" method="POST" class="form-horizontal" role="form">
			...
			<div class="form-group">
				<label for="password" class="col-sm-2 control-label">Parolă nouă:</label>
				<div class="col-sm-10">
					<input type="password" class="form-control" id="password" name="password" placeholder="Alege o nouă parolă">
				</div>
			</div>
			<div class="form-group">
				<label for="password_confirmation" class="col-sm-2 control-label">Repetă noua parolă:</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-success">Salvează parola</button>
				</div>
			</div>		
		</form>
