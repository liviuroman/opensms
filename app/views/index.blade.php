@extends('master')
	...
	@section('content')
		...
		<div class="jumbotron" style="text-align:left">
			...
			<p class="lead">Cu OpenSMS poti trimite SMS-uri gratuit catre orice telefon de mobil din Romania. Deasemenea, poti integra <b>OpenSMS</b> in orice aplicatie pentru a trimite alerte SMS in real-time.</p>
