...
{{ Form::open(array('url' => 'contact', 'class' => 'form-horizontal', 'role' => 'form')) }}
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<textarea class="form-control" name="message" class="message" id="textarea" placeholder="Întrebări / sugestii / nelămuriri" required>{{ Input::old('message') }}</textarea>
		</div>
	</div>
	<div class="form-group">
...
var heightLimit = 350; /* Maximum height: 200px */
